...
$Biz_Name = getRequestData('Biz_Name');
$Biz_Address = getRequestData('Biz_Address');
$Biz_City = getRequestData('Biz_City');
$Biz_Telephone = getRequestData('Biz_Telephone');
$Biz_URL = getRequestData('Biz_URL');
$Biz_Categories = getRequestData('Biz_Categories');
